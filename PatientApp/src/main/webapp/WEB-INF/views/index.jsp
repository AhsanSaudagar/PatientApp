...
<head>
    ...
    <script type="text/javascript">
        ...
        function registration() {
            ...
            window.location = contextPath + '/patientApp/registration';
        }
        function initApp() {
            ...
            document.getElementById('registration').addEventListener('click', registration, false);
        }
        ...
        <div class="row">
            <div class="col-md-6 py-5 pr-md-5">
                <div class="heading-section heading-section-white ftco-animate mb-5">
                    ...
                    <p>Login with your credentials to check your schedule</p>
                </div>
                <form action="#" class="appointment-form ftco-animate">
                    ...
                    <div class="d-md-flex">
                        <div class="form-group">
                            <a style="color:white" href="https://www.w3schools.com">Forgot Password</a>
                    ...
                    <div class="d-md-flex">
                        <div class="form-group ml-md-4">
                            <button class="btn btn-secondary py-3 px-4" id="quickstart-sign-in" name="signin">Sign In</button>
