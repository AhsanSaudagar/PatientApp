      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Medicine Schedule</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Medicine Schedule <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section> -->
    	...
    	<div class="container">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>Detailed entries which shows your medicine schedule</p>
          </div>
        </div>
        <table align="center" border="1">
            ...
            <tr>
                    <td><label>1 Jan 2020</label></td>
                    <td><label>Pari 10mg</label></td>
                    <td><input type="checkbox" name="taken" value="taken"></td>
                    <td><input type="checkbox" name="panic" value="panic"></td>
                </tr>
                <tr>
                        <td><label>1 Jan 2020</label></td>
                        <td><label>Pari 10mg</label></td>
                    ...
                    <tr>
                        ...
                        <tr>
                                <td><label>1 Jan 2020</label></td>
                                <td><label>Divaa od 500</label></td>
                                <td><input type="checkbox" name="taken" value="taken"></td>
                                <td class="tcenter"><input type="checkbox" name="panic" value="panic"></td>
                            </tr>
        </table>
